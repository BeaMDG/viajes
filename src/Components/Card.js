...
const Card = ({ loadingData, showData, weather, forecast }) => {
  ...
  if (loadingData) {
    return <Spinner />;
  } else if (showData && weather && forecast) {
    // Resto del código
  } else {
    return <h2 className="text-white">Sin datos</h2>;
  }
  ...
  return (
    <div className="mt-5">
      <div className="container">
        <div className="card mb-3 mx-auto bf-dark text-black">
          <div className="row g-0">
            <div className="col-md-4">
              <h3 className="card-title-weather">{weather.name}</h3>
              ...
              <img
                src="https://images.pexels.com/photos/2470655/pexels-photo-2470655.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
